...
#override configure_permitted_parameters method to allow additional parameters
  ...
  def configure_permitted_parameters
      ...
      devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :major, :grad_date])
      # parameters that can be updated
      devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :major, :grad_date])
  end
